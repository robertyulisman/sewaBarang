...
import { EvilIcons, Entypo, FontAwesome, FontAwesome5, MaterialCommunityIcons, AntDesign} from 'react-native-vector-icons';
      ...
      const _icon_position_right = this.scroll_x.interpolate({
        ...
        return (
          <View style={{flex: 1}}>
            ...
            >
            <Text style={{fontSize: 25, fontWeight: 'bold', color: 'white', top: 10}}>Toko</Text>
              <View style={{...styles.fake_icon_box, top: 10}}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('SearchFeed')}>
            ...
            <View style={styles.container1}>
              ...
              >
                <Image source={{uri: 'https://scontent.fcgk25-1.fna.fbcdn.net/v/t31.0-8/13443200_360429417414849_3584700450972541967_o.jpg?_nc_cat=106&_nc_sid=e3f864&_nc_eui2=AeFi68PojLAphC_Bmm_wMA8EfsRlmUC-6xR-xGWZQL7rFLx6Z108HAIcoAmrAYrx4cABvG5Xb61LR9PUaaxRQutq&_nc_ohc=PWPeB5Nawt8AX9be-GP&_nc_ht=scontent.fcgk25-1.fna&oh=2c105d4fb3e91cac03c15b59f0e528cb&oe=5EF91905'}} style={styles.image} />
              </Animated.View>
                    {/* Call to action */}
                ...
                <View style={{top: 15, flex: 1}}>
                  <View
                    ...
                    >
                        <Image
                        source={{uri: 'https://scontent.fcgk25-1.fna.fbcdn.net/v/t31.0-8/13443200_360429417414849_3584700450972541967_o.jpg?_nc_cat=106&_nc_sid=e3f864&_nc_eui2=AeFi68PojLAphC_Bmm_wMA8EfsRlmUC-6xR-xGWZQL7rFLx6Z108HAIcoAmrAYrx4cABvG5Xb61LR9PUaaxRQutq&_nc_ohc=PWPeB5Nawt8AX9be-GP&_nc_ht=scontent.fcgk25-1.fna&oh=2c105d4fb3e91cac03c15b59f0e528cb&oe=5EF91905'}}
                        style={{
                            width: 50,
                            height: 50,
                            borderColor: 'blue',
                      ...
                      <FlatList
                          ...
                          renderItem={({ item }) => (
                              <View style={{ flex: 1, flexDirection: 'column', margin: 1, top: 10}}>
