...
import { View, ScrollView, Text, ImageBackground, StyleSheet, Image, TextInput, ActivityIndicator, FlatList, TouchableNativeFeedback, StatusBar, Platform, TouchableOpacity, RefreshControl, Dimensions } from 'react-native';
...
import Svg, { Constants, ClipPath, Path } from 'react-native-svg';
  ...
  randomNumber = Math.floor(Math.random() * 7)
    ...
    return(
      <View style={{flex: 1, width: width}}>
        ...
        >
        <Image source={require('../components/kendaraan/img/bgk.png')} style={[styles.imageStyle, {height: Platform.OS == 'ios'? this.state.imageHeight : hp('45%'), marginTop: Platform.OS == 'ios'? this.state.marginTop : 0}]}/>
          <View style={styles.bg}>
            ...
            <Swipeable
              ...
              <View style={[styles.listItem, {backgroundColor: 'transparent'}]}>
                <Image
                  source={require('../components/kendaraan/img/4.png')}
            ...
            <Swipeable
              ...
              <View style={[styles.listItem, {backgroundColor: 'transparent'}]}>
                <Image
                  source={require('../components/kendaraan/img/1.png')}
                  style={{height: 65, width: 65, resizeMode: 'stretch'}}
                />
            ...
            <Swipeable
              ...
              <View style={[styles.listItem, {backgroundColor: 'transparent'}]}>
                <Image
                  source={require('../components/kendaraan/img/5.png')}
