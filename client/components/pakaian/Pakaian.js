          ...
          <View style={styles.bg}>
            ...
            <Swipeable
              ...
              <View style={[styles.listItem, {backgroundColor: 'transparent'}]}>
                <Image
                  ...
                  style={{height: 65, width: 65, resizeMode: 'stretch', left: '-15%'}}
                />
                <Text style={{color: 'black', fontWeight: 'bold', fontSize: 15}}>Jas</Text>
            ...
            <Swipeable
              ...
              <View style={[styles.listItem, {backgroundColor: 'transparent'}]}>
                ...
                />
                <Text style={{color: 'black', fontWeight: 'bold', fontSize: 15}}>Kebaya</Text>
                <Text style={{color: '#ddd', fontSize: 10}}> Geser ke kiri untuk melihat informasi</Text>
              </View>
            </Swipeable>
